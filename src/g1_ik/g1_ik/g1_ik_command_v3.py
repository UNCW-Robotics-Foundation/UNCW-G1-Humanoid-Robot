...
import numpy as np
from g1_ik.robot_arm_ik_task import G1_29_ArmIK
...
class MinimalSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.debug_pub = self.create_publisher(
            ...
            'ik_debug',
            10)
        self.share_arm_pub = self.create_publisher(
            ArmStates,
            'ik_arms',
            10)
    ...
    def target_callback(self, msg):
            ...
            self.matrix[0, 3] = self.current_target.x + initial_x
            self.matrix[1, 3] = self.current_target.y + initial_y
            self.matrix[2, 3] = self.current_target.z + initial_z
            self.target_received = True
            self.share_arm_pub.publish(self.current_arms)
            #self.traj_flag = True
